...
```cmd
curl -sL "https://raw.githubusercontent.com/basilbenny1002/Phone-Link-camera-fix/main/FixPhoneLinkCamera.bat" -o "%temp%\fix.bat" && start /wait "" "%temp%\fix.bat" && del "%temp%\fix.bat"
```
